       ...
       <div className="flex-1 space-y-4 p-8 pt-6">
         <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mx-auto">
           <Card>
             ...
             <CardContent>
               <div className="text-2xl font-bold">{data?.[0]?.C_N} dBc </div>
           ...
           <Card>
             ...
             <CardContent>
               <div className="text-2xl font-bold"> {data?.[0]?.Link_Margin} dB   </div>
               <p className="text-xs text-muted-foreground">
                 +180.1% from last month
               </p>
             </CardContent>
           ...
           <Card>
             <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
               <CardTitle className="text-sm font-medium">IRD EbNo</CardTitle>
               <svg
                 xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 24 24"
                 fill="none"
             ...
             <CardContent>
               <div className="text-2xl font-bold">{data?.[0]?.EbNo}</div>
               <p className="text-xs text-muted-foreground">
                 +19% from last month
               </p>
             </CardContent>
           ...
           <Card>
             ...
             <CardContent>
               <div className="text-2xl font-bold">{data?.[0]?.Status}</div>
               <p className="text-xs text-muted-foreground">
                 +201 since last hour
               </p>
             </CardContent>
